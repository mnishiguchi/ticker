  ...
  class AppTest < Minitest::Test
    describe ".query" do
      it "returns an array of five-element tuples" do
        assert_equal [["SPY", 369.33, -0.74002075, -0.19996777, "*"]], Ticker::App.query("SPY", QueryApiStub)
      end
    end
    ...
    class QueryApiStub
      ...
      API_RESULT_STUB = [{ "language" => "en-US", "region" => "US", "quoteType" => "ETF", "triggerable" => true,
                           ...
                           "exchangeDataDelayedBy" => 0, "symbol" => "SPY" }].freeze
    end
  end
end
